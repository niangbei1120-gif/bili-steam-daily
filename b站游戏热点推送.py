...
4.  **精准分类**：将所有符合条件的内容归入以下四类，按顺序输出，优先级依次降低。
    ...
    *   **平台活动**：Steam新品节、游戏节等**当前正在进行中**的官方展示活动（注意：新品节已结束则不应入选）；Steam平台规则调整、审核政策变更、商店标签更新等影响发行的平台机制变化。**不包含任何促销折扣内容。** 最多2条，放在最后。**关键：必须确认该活动确实正在举办中，不要把某个游戏的普通试玩视频包装成"官方展示活动"。**
